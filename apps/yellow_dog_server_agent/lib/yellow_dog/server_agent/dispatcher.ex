defmodule YellowDog.ServerAgent.Dispatcher do
  @moduledoc """
  Stateless durable dispatch boundary for local Server commands.
  """
  ...
  @allowed_options [:server_id, :capabilities, :command_journal, :runtime_adapter]
  @error_messages %{
