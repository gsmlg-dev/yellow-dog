          ...
          <.card :for={service <- @services} class="hover:shadow-2xl transition-shadow">
            ...
            <div class="space-y-2">
              ...
              <%= if service.status == "Running" do %>
                <div class="flex items-center justify-between text-sm">
                  <span class="text-base-content/60">Supervisor PID</span>
