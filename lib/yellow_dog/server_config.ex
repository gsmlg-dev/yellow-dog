defmodule YellowDog.ServerConfig do
  @moduledoc """
  Documentation for `YellowDog.ServerConfig`.
  """
  ...
  def udp_config(config = %YellowDog.ServerConfig{}) do
    [
      port: config.port,
      transport_options: [debug: true],
      handler_module: YellowDog.Handler.UDP,
      handler_options: [],
      genserver_options: [],
      supervisor_options: [],
      num_listeners: 100,
